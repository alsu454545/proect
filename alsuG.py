...
with tab1:
    ...
    activ = streamlit.radio("Ваш уровень активности:", ["Не активный(сидячая офисная работа)","Малоактивный(легкая работа на ногах)","Среднеактивный(работа с постоянным движением или интенсивные тренировки 3-5 раз в неделю)","Активный(тяжелый физический труд или интенсивные тренировки каждый день)"])        
    ...
    if streamlit.button("Рассчитать суточную норму"):
        ...
        # расчет калорий по мере активеости
        if activ == "Не активный(сидячая офисная работа)" :
            daily_norm = int(bmr * 1.2)
        elif activ == "Малоактивный(легкая работа на ногах)":
            daily_norm = int(bmr * 1.375)
        elif activ == "Среднеактивный(работа с постоянным движением или интенсивные тренировки 3-5 раз в неделю)":
            daily_norm = int(bmr * 1.55)
        else:
            daily_norm = int(bmr * 1.725)
